...
public class UserStore {
	...
	/**
	 * Returns the singleton instance of UserStore that should be shared between
	 ...
	 */
	public static UserStore getTestInstance(
			PersistentStorageAgent persistentStorageAgent) {
		return new UserStore(persistentStorageAgent);
	}

	/**
	 * The PersistentStorageAgent responsible for loading Users from and saving
	 * Users to Datastore.
	 */
	...
	/**
	 * Add a new user to the current set of users known to the application. This
	 * should only be called to add a new user, not to update an existing user.
	 */
	...
	/**
	 * Sets the List of Users stored by this UserStore. This should only be
	 * called once, when the data is loaded from Datastore.
	 */
